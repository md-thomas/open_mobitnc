...
#
# Requires kiss_bridge.py to not be running (the TNC allows only one
# Bluetooth connection at a time) -- stop it first with
# scripts/stop_radio.sh if it's up.
#
...
# bleak/customtkinter installed would fail that.
